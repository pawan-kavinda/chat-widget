class AgentWidget extends HTMLElement {
  ...
  get config() {
    return {
      ...
      primaryColor: this.getAttribute("primary_color") || "#dcdde1ff",
      secondaryColor: this.getAttribute("secondary_color") || "#b5b5b5ff",
      ...
      <style>
        * {
        ...
        .chat-btn {
          ...
          height: 64px;
          border-radius: 12px;
          background: linear-gradient(135deg, #ecf1ffff 0%, #838383ff 100%);
          color: #fff;
          display: flex;
        ...
        .chat-btn:hover {
          ...
          box-shadow: 0 12px 32px rgba(30, 64, 175, 0.3), 0 4px 12px rgba(0, 0, 0, 0.15);
        }
  ...
  initChatbot() {
    ...
    root.querySelector(".header").style.background = `linear-gradient(135deg, ${primaryColor} 0%, ${secondaryColor} 100%)`;
